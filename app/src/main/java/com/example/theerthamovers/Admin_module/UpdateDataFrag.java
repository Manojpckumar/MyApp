 ...
 * Use the {@link UpdateDataFrag#newInstance} factory method to
...
public class UpdateDataFrag extends Fragment {
     ...
     * @return A new instance of fragment UpdateDataFrag.
     */
    // TODO: Rename and change types and number of parameters
    public static UpdateDataFrag newInstance(String param1, String param2) {
        UpdateDataFrag fragment = new UpdateDataFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ced_dname = view.findViewById(R.id.ced_dnamew);
        ced_vnum = view.findViewById(R.id.ced_vnumw);
        ced_modelno = view.findViewById(R.id.ced_modelnow);
        ced_cate = view.findViewById(R.id.ced_catew);
        ced_loca = view.findViewById(R.id.ced_locaw);
        ced_stread = view.findViewById(R.id.ced_streadw);
        ced_sttime = view.findViewById(R.id.ced_sttimew);
        ced_endred = view.findViewById(R.id.ced_endredw);
        ced_endtime = view.findViewById(R.id.ced_endtimew);
        ced_diesal = view.findViewById(R.id.ced_diesalw);
        ced_food = view.findViewById(R.id.ced_foodw);
        ced_grease = view.findViewById(R.id.ced_greasew);
        ced_noil = view.findViewById(R.id.ced_noilw);
        ced_spare = view.findViewById(R.id.ced_sparew);
        ced_other = view.findViewById(R.id.ced_otherw);
        ced_wodate = view.findViewById(R.id.ced_wodatew);
        ced_hoil = view.findViewById(R.id.ced_hoilw);
        ced_salary = view.findViewById(R.id.ced_salaryw);


        GetAllByIdee byId = new GetAllByIdee();
        byId.execute();
...
//        materialButton.setTextColor(getString(R.color.colorWhite));
        ...
        materialButton.getButton().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    UpdatePhaseSecondee phaseSecond = new UpdatePhaseSecondee(v);
                    phaseSecond.execute();
    ...
    class UpdatePhaseSecondee extends AsyncTask<Void, Void, String> {

        View vi;

        public UpdatePhaseSecondee(View vee) {
            this.vi = vee;
        }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!obj.getBoolean("error")) {
                    ...
                    {
                        UpdateBillStatusz status = new UpdateBillStatusz(vi);
                        status .execute();
        ...
        protected String doInBackground(Void... voids) {
            ...
            return requestHandler.sendPostRequest("https://sysirohub.com/theerthaearthmovers/phase1/v1/Api.php?apicall=updatedata", params);
        }
    }

    class UpdateBillStatusz extends AsyncTask<Void, Void, String> {

        View vee;

        public UpdateBillStatusz(View vi) {
            this.vee=vi;
        }
    ...
    class GetAllByIdee extends AsyncTask<Void, Void, String> {
