...
public class MaterialButtonProcess {
    ...
    private CustomTextView button_text;

    public MaterialButtonProcess(View view) {
        setType(view);
    }

    public MaterialButtonProcess() {
    }

    private void setType(View view) {
        button_style_parent = view.findViewById(R.id.btn_submit);
    ...
    public String getText() {
        return button_text.getText().toString();
    }
    ...
    public void setActivated(boolean isVisible) {
        if (isVisible) {
            button_style_parent.setVisibility(View.VISIBLE);
        } else {
            button_style_parent.setVisibility(View.GONE);
        }
    }
